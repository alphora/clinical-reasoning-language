...
class CPGLLexer extends Lexer_1.Lexer {
    get vocabulary() {
        return CPGLLexer.VOCABULARY;
    }
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(CPGLLexer._ATN, this);
    }
    get grammarFileName() { return "CPGLLexer.g4"; }
    get ruleNames() { return CPGLLexer.ruleNames; }
    get serializedATN() { return CPGLLexer._serializedATN; }
    get channelNames() { return CPGLLexer.channelNames; }
    get modeNames() { return CPGLLexer.modeNames; }
    ...
    ACTIVITY_TYPE_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 0:
                const validTypes = [
                ...
                if (!validTypes.includes(this.text)) {
                    for (const listener of this.getErrorListeners()) {
                        if (typeof listener.reportCustomError === 'function') {
                            listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid activity type: ${this.text}`, { validTypes, received: this.text });
                        }
                    }
                }
                break;
    ...
    ACTIVITY_ErrorChar_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 1:
                for (const listener of this.getErrorListeners()) {
                    if (typeof listener.reportCustomError === 'function') {
                        listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid character in activity type: ${this.text}`, { received: this.text });
                    }
                }
                break;
        }
    }
    CONCEPT_TYPE_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 2:
                const validTypes = [
                    'Communication',
                ...
                if (!validTypes.includes(this.text)) {
                    for (const listener of this.getErrorListeners()) {
                        if (typeof listener.reportCustomError === 'function') {
                            listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid concept type: ${this.text}`, { validTypes, received: this.text });
                        }
                    }
                }
                break;
    ...
    CONCEPT_ErrorChar_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 3:
                for (const listener of this.getErrorListeners()) {
                    if (typeof listener.reportCustomError === 'function') {
                        listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid character in concept type: ${this.text}`, { received: this.text });
                    }
                }
                break;
        }
    }
    CONCEPT_VALUE_TYPE_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 4:
                const validTypes = [
                    'Quantity',
                ...
                if (!validTypes.includes(this.text)) {
                    for (const listener of this.getErrorListeners()) {
                        if (typeof listener.reportCustomError === 'function') {
                            listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid concept value type: ${this.text}`, { validTypes, received: this.text });
                        }
                    }
                }
                break;
    ...
    VALUE_TYPE_ErrorChar_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 5:
                for (const listener of this.getErrorListeners()) {
                    if (typeof listener.reportCustomError === 'function') {
                        listener.reportCustomError(this._tokenStartLine, this._tokenStartCharPositionInLine, `Invalid character in concept value type: ${this.text}`, { received: this.text });
                    }
                }
                break;
        }
    ...
    static get _ATN() {
        if (!CPGLLexer.__ATN) {
            CPGLLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(CPGLLexer._serializedATN));
        }
        return CPGLLexer.__ATN;
    }
}
exports.CPGLLexer = CPGLLexer;
CPGLLexer.CONCEPT = 1;
CPGLLexer.TYPE = 2;
CPGLLexer.VALUETYPE = 3;
CPGLLexer.TERMINOLOGY = 4;
CPGLLexer.PROVENANCE = 5;
CPGLLexer.INFERRED = 6;
CPGLLexer.AND = 7;
CPGLLexer.OR = 8;
CPGLLexer.NOT = 9;
CPGLLexer.DONE = 10;
...
CPGLLexer.BY = 12;
CPGLLexer.CODED = 13;
CPGLLexer.VALUESET = 14;
CPGLLexer.PERFORM = 15;
CPGLLexer.ACTIVITY = 16;
CPGLLexer.OF = 17;
CPGLLexer.SYSTEM = 18;
CPGLLexer.CODE = 19;
CPGLLexer.DO = 20;
...
CPGLLexer.ANY = 24;
CPGLLexer.ALL = 25;
CPGLLexer.DECISION = 26;
CPGLLexer.BECAUSE = 27;
CPGLLexer.ERROR = 28;
CPGLLexer.COLON = 29;
CPGLLexer.DOT = 30;
CPGLLexer.LPAREN = 31;
CPGLLexer.RPAREN = 32;
CPGLLexer.QUOTED_STRING = 33;
CPGLLexer.BACKTICK_STRING = 34;
CPGLLexer.WS = 35;
CPGLLexer.COMMENT = 36;
CPGLLexer.COMMENT_BLOCK = 37;
CPGLLexer.ACTIVITY_TYPE = 38;
CPGLLexer.ACTIVITY_WS = 39;
CPGLLexer.ACTIVITY_COMMENT_BLOCK = 40;
CPGLLexer.ACTIVITY_ErrorChar = 41;
CPGLLexer.CONCEPT_TYPE = 42;
CPGLLexer.CONCEPT_WS = 43;
CPGLLexer.CONCEPT_COMMENT_BLOCK = 44;
CPGLLexer.CONCEPT_ErrorChar = 45;
CPGLLexer.CONCEPT_VALUE_TYPE = 46;
CPGLLexer.VALUE_TYPE_WS = 47;
CPGLLexer.VALUE_TYPE_COMMENT_BLOCK = 48;
CPGLLexer.VALUE_TYPE_ErrorChar = 49;
CPGLLexer.ACTIVITY_MODE = 1;
CPGLLexer.CONCEPT_MODE = 2;
CPGLLexer.VALUE_TYPE_MODE = 3;
CPGLLexer.channelNames = [
...
CPGLLexer.ruleNames = [
    ...
    "ACTIVITY", "OF", "SYSTEM", "CODE", "DO", "USE", "WHEN", "THEN", "ANY",
    "ALL", "DECISION", "BECAUSE", "ERROR", "COLON", "DOT", "LPAREN", "RPAREN",
...
CPGLLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(CPGLLexer._LITERAL_NAMES, CPGLLexer._SYMBOLIC_NAMES, []);
CPGLLexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x023\u01A0\b\x01" +
    ...
    "*\xE8\x03\x02\x02\x02,\xED\x03\x02\x02\x02.\xF0\x03\x02\x02\x020\xF4\x03" +
    "\x02\x02\x022\xF9\x03\x02\x02\x024\xFE\x03\x02\x02\x026\u0102\x03\x02" +
    "\x02\x028\u0106\x03\x02\x02\x02:\u010F\x03\x02\x02\x02<\u0117\x03\x02" +
    ...
    "\x02\x02\x02\xED\xEE\x07f\x02\x02\xEE\xEF\x07q\x02\x02\xEF-\x03\x02\x02" +
    "\x02\xF0\xF1\x07w\x02\x02\xF1\xF2\x07u\x02\x02\xF2\xF3\x07g\x02\x02\xF3" +
    "/\x03\x02\x02\x02\xF4\xF5\x07y\x02\x02\xF5\xF6\x07j\x02\x02\xF6\xF7\x07" +
