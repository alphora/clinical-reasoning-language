...
fixture.querySelectorAll('.route-card-edit')[1].click();result.openEditors=fixture.querySelectorAll('.route-card-editor:not([hidden])').length;
...
[...fixture.querySelectorAll('.route-card-toolbar button')].find(b=>b.textContent==='Questionnaire').click();result.columnCards=fixture.querySelectorAll('.route-card').length;result.connectors=fixture.querySelectorAll('.route-card-connector').length;result.draft=fixture.querySelector('.route-card-editor:not([hidden]) textarea').value;
