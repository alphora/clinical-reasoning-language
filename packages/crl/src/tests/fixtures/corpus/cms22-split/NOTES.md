...
| `cms22-concepts.crl` | `"CMS22 Concepts"` | terminology | terminology declarations (valuesets, codes) + the Measurement Period runtime parameter (declarative since v2.2.0) |
...
`coded from "CMS22 Concepts"."Encounter to Screen for Blood Pressure"`).
...
`CMS22.cql`, `CMS22 Inferred.cql`, `CMS22 Asserted.cql`, `CMS22 Concepts.cql`.
