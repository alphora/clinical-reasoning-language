 ...
 * (`tmp/_old/PLAN-truthset-retire.md` §2, plan of record; panel disc 477/478/479, operator-chosen option (A)).
 *
...
describe("#189 T5-CQL step 1 — truth-set retirement inventory", () => {
  it("enumerates every bare-scalar and E1 concept in the corpus", () => {
    ...
    const out: string[] = [
      ...
      "Plan of record: `tmp/_old/PLAN-truthset-retire.md` §2. This is its \"CONFIRM + complete\".",
      "",
