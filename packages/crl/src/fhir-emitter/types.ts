 ...
 *   (emit-casefeature-non-boolean was REMOVED — the LocalElements-always-boolean rule: every `code is` concept is a boolean Observation case-feature regardless of declared value type, so there is no value-type gate.)
