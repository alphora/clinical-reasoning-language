...
Baseline: 0a164fdc83b49d9ba9a9a9cb9261fb83f4399169. Target: pending reviewed content commit. Kit schema 2.17; hash pending canonical export. The engine adoption changed generated Questionnaire shape without changing the existing group-only teaching. A matching content hash did not establish that this runtime-dependent claim remained valid. This section corrects that earlier audit conclusion.
